export default function Steps() {
  const steps = [
    { title: "Załóż konto", desc: "Szybka rejestracja i gotowe." },
    {
      title: "Nadajcie jej Wasz styl",
      desc: "Wybierzcie kolor, zdjęcia i układ.",
    },
    { title: "Wybierzcie własny adres", desc: "Personalizowany adres strony." },
    {
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-4 gap-4">
          {steps.map((s) => (
            <div key={s.title} className="p-4 text-center">
              <div className="h-12 w-12 mx-auto rounded-full bg-rose-100 text-rose-900 flex items-center justify-center font-semibold">
                ✓
              </div>
